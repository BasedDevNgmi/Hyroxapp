    ...
    <div className="bg-card rounded-2xl border border-border overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium">Warm-up / Prehab Protocol</p>
            <p className="text-xs text-muted-foreground">IT-band, ankles, glutes — do this every session</p>
          </div>
        </div>
        {expanded ? (
      ...
      {expanded && (
        <div className="px-5 pb-4 space-y-2">
          ...
          <p className="text-[10px] text-muted-foreground/60 mt-2 italic">
            Not tracked as sets — just do it as your warm-up.
          </p>
        </div>
      )}
    </div>

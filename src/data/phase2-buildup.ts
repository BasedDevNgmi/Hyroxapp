  ...
  return [
    ...
    // ── DI: Hybrid Run + Stations ──
    {
      ...
      workout_exercises: isDeload ? [
        ...
        we(`w${w}-2`, exercises.sled_push, 4, { sets: 3, distance_meters: 50, notes: 'Race weight, heen en weer met pull' }),
        we(`w${w}-2`, exercises.sled_pull, 5, { sets: 3, distance_meters: 50, notes: 'Race weight, tempo' }),
    ...
    // ── ZA: Hyrox Pairs ──
    {
      ...
      workout_exercises: isDeload ? [
        ...
        we(`w${w}-6`, exercises.sled_push, 3, { sets: 1, distance_meters: 50, notes: 'Roteer stations per week' }),
  ...
  return [
    ...
    // ── VR: Lower — Peak Deadlift ──
    {
      ...
      workout_exercises: isTest ? [
        ...
        we(`w${w}-5`, exercises.sled_push, 2, { sets: 2, distance_meters: 50, notes: 'Licht — race distance, matige effort' }),
        we(`w${w}-5`, exercises.sled_pull, 3, { sets: 2, distance_meters: 50, notes: 'Race distance' }),
        ...
        we(`w${w}-5`, exercises.sled_push, 3, { sets: 3, distance_meters: 50, notes: 'Race distance, matige effort' }),
        we(`w${w}-5`, exercises.sled_pull, 4, { sets: 3, distance_meters: 50 }),

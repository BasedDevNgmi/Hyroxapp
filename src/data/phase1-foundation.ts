...
function weeks1to4(w: number): Workout[] {
  ...
  return [
    ...
    // ── WO: Upper Kracht ──
    {
      ...
      workout_exercises: [
        we(`w${w}-3`, exercises.bench_press, 1, { sets: isDeload ? 3 : 4, reps: '6', notes: 'RPE 7 — bepaal startgewicht week 1' }),
        we(`w${w}-3`, exercises.ohp, 2, { sets: 3, reps: '8', notes: 'RPE 7' }),
        we(`w${w}-3`, exercises.barbell_row, 3, { sets: isDeload ? 3 : 4, reps: '8' }),
        we(`w${w}-3`, exercises.pullups, 4, { sets: 4, reps: 'Max', notes: 'Gewogen als je 12+ kan' }),
        we(`w${w}-3`, exercises.db_lateral_raise, 5, { sets: 3, reps: '15' }),
        we(`w${w}-3`, exercises.face_pulls, 6, { sets: 3, reps: '15' }),
        we(`w${w}-3`, exercises.ez_curl, 7, { sets: 3, reps: '10' }),
        we(`w${w}-3`, exercises.tricep_dips, 8, { sets: 3, reps: '10' }),
        we(`w${w}-3`, exercises.ab_wheel, 9, { sets: 3, reps: '8' }),
        we(`w${w}-3`, exercises.pallof_press, 10, { sets: 3, reps: '10/side' }),
      ],
    },
